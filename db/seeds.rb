...
jeremy  = User.create(first_name: "Jeremy", last_name: "Boom", facebook_picture_url: "https://pbs.twimg.com/profile_images/767015623184482304/5qhj67dd_400x400.jpg", email: "jeremy@gmail.com", password: "123456")
...
yoga = Listing.new(title: "Yoga Retreat", caption: "Best yoga retreat (caption)",description: "Amazing yoga retreat", price: 40, address: "Ahornsgade 15, Copenhagen")
yoga.user = jeremy
yoga.photo_url = url
yoga.save
...
meditation = Listing.new(title: "Meditation Retreat", caption: "Best meditation retreat (caption)",description: "Amazing meditation retreat", price: 40, address: "Ahornsgade 15, Copenhagen")
